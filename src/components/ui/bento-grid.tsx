        ...
        <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4 w-full">
            {items.map((item, index) => (
                <Link
                    ...
                    key={index}
                    className={cn(
                        "block group relative p-4 rounded-xl overflow-hidden transition-all duration-300",
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="space-y-2">
                            <h3 className="font-medium text-gray-900 dark:text-gray-100 tracking-tight text-[15px]">
                                {item.title}
                                <span className="ml-2 text-xs text-emerald-500 font-bold bg-emerald-500/10 px-2 py-0.5 rounded">
                                    {item.meta}
                                </span>
                            </h3>
